...
func edge_project(pts: [[Double]], fd : ([[Double]],[Double]?,Double?) -> [Double], h0:Double=1.0) -> [[Double]] {
    //    project points back on edge
    let g_vec = edge_grad(p: pts, fd: fd, h0: h0)
    var final : [[Double]] = []
    var temp : [Double] = []
...
func edge_grad(p: [[Double]], fd : ([[Double]],[Double]?,Double?) -> [Double], h0:Double=1.0)-> [[Double]]{
    /*
